...
Let TaskBoard move task data in and out as JSON so a homelab deployment can be backed up, migrated, or seeded before deeper database operations are added.
